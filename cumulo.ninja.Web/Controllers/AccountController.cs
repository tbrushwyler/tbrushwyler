...
namespace cumulo.ninja.Web.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new IdentityUser(new User() { UserName = model.Email, Email = model.Email });
        ...
        public async Task<ActionResult> ExternalLoginConfirmation(ExternalLoginConfirmationViewModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                // if the email is already part of an account, associate the login with that user
                ...
                // create a new user
                user = new IdentityUser(new User() {UserName = model.Email, Email = model.Email});
